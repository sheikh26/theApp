...
/**
 * This <java>class</java> AppUserCoinBalance having DB table and column names.
 * 
 * @author param Sheikh
 * @GWL
 */
...
@XmlRootElement
@Entity
@Table(name = "ta_user_coin_balance")
public class AppUserCoinBalance implements Serializable
{
