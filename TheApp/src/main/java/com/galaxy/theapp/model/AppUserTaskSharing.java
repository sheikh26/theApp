...
/**
 * This <java>class</java> AppUserTaskSharing having DB table and columns names.
 * 
 * @author Mayank Jain
 * @GWL
 */
...
@XmlRootElement
@Entity
@Table(name = "ta_tasksharing")
public class AppUserTaskSharing implements Serializable
{
